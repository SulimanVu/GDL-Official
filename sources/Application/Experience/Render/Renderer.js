...
export default class Renderer {
  ...
  setPostProcess() {
    ...
    // TAA
    this.postProcess.taaRenderPass = new TAARenderPass(
      this.scene,
      this.camera.instance
    );
...
void main() {
  ...
  setDebug() {
    ...
    taaPassFolder
      .add(this.postProcess.taaRenderPass, "enabled")
      .name("enabled");
    taaPassFolder
    ...
    // Unreal Bloom pass
    const unrealBloomPassFolder = debug.ui.getFolder(
      "renderer/unrealBloomPass"
    );
    unrealBloomPassFolder
      .add(this.postProcess.unrealBloomPass, "enabled")
      .name("enabled");
    unrealBloomPassFolder
